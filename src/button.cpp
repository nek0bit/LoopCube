...
Button::Button(const Graphics& graphics,
               unsigned int id,
			   int x,
			   int y, 
			   int width, 
...
void Button::update(EventWrapper& events, Timer&, int offsetX, int offsetY) {
	src.x = 0;
...
void Button::render(const Graphics& graphics, TextureHandler& textures, int offsetX, int offsetY)
{
